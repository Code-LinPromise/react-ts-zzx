...
const SearchMain = () => {
    ...
    useEffect(()=>{
        let items:any=document.querySelectorAll(".Toggle")
        let scroll:any=document.querySelector(".Toggle-scroll")
    ...
    function GetToggleBottomNum(number:number){
        setPlaceHolderNum(number)
    }
    function IsNull(e:any){
        let input:any =document.querySelector(".Toggle-input")
        if(input.value===""){
            e.preventDefault()
        }
    }
    function RecordDetails(e:any){
